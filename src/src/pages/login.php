    ...
    if($_SERVER["REQUEST_METHOD"] === "POST"){
        ...
        if(!$email) {
            ...
            if($email){
                ...
                if($userEmail) {
                    if($password) {
                        if(hash("sha512",$password) === $userEmail["password"]) {
                            ...
                            $emailErrorClass = 'error';
                            $emailErrorText = 'E-mail or password in incorrect';
        ...
        // if($emailErrorClass === "success" && $passwordErrorClass=== "success" && $password2ErrorClass === "success") {
                    ...
                    <div class="form__inner fx-column mw-350">
                        ...
                        <div class="form-control w-100">
                            <div class="form-input no-pd <?php echo $passwordErrorClass ?>">
                                <input class="pass" type="password" name="password" placeholder="Password" value="<?php echo $password ?>">
                                <div class="showHide">
